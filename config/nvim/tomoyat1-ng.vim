...
hi Error	guifg=#eeeeee guibg=#ff5454 ctermfg=15 ctermbg=1
hi ErrorMsg	guifg=#eeeeee guibg=#ff5454 ctermfg=15 ctermbg=1
hi Todo		guifg=#0c0d0e guibg=#ffd154 ctermfg=0 ctermbg=3
